...
<body>
	...
	<div id="altclicker" class="container-fluid">
		...
		<div class="row py-0 px-0">
			...
			<div class="rounded shadow wb-widget col-md p-2 m-1 ">
				<h3 class="mt-0"><span class="fas fa-charging-station" style="color: var(--color-charging)">&nbsp;</span>Ladepunkte <small id="LadereglerTxt"> notext </small></h3>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-10 px-0">
					<h3><span class="fas fa-car-battery" style="color: var(--color-battery)">&nbsp;</span>Speicher<small id="BatSupportTxt"> notext </small></h3>
				</div>
				<?php makebatmenu(); ?>
