...
?>
		...
		<script src = "<?php echo geturl('css/ladelog_style.css');?>"></script>
		...
		<script src = "<?php echo geturl('logging/chargelog/helperFunctions.js');?>"></script>
		<script src = "<?php echo geturl('js/mqtt.js');?>"></script>
		<script src = "<?php echo geturl('logging/chargelog/ladelog.js');?>"></script>
		<script>
		...
		<div id="nav"></div> <!-- placeholder for navbar -->
 		...
 		<div role="main" class="container">
			...
			<div class="row justify-content-center">
				...
				<div class="col-8 col-sm-6 col-md-5 col-lg-4">
                    <div class="btn-group">
                        <a href="ladelog.php?do=export" class="btn btn-primary active">
                            <i class="fa fa-save"></i> Export als CSV </a>
                    </div>
				</div>
			</div>
